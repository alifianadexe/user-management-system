                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <div class="col-md-13 text-end">
                            <a href="{{ route('stocks.show')}}" data-bs-toggle="tooltip" data-bs-title="Add" class="btn btn-primary btn-sm">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-3 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $stock->resource_name }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle text-end">
                                                <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                                    ...
                                                    <a href="{{ route('stocks.delete', ['id' => encrypt($stock->id)]) }}" data-bs-toggle="tooltip" data-bs-title="Delete" class="ms-2">
