...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('/img/tema-ijo.jpg'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome</h1>
                        <p class="text-lead text-white">Create your new account for free.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="firstname" class="form-control" placeholder="Firstname" aria-label="Name" >
                                    @error('firstname') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                </div>
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="lastname" class="form-control" placeholder="Lastname" aria-label="Name" >
